...
\vspace{1em}
\noindent
\savebox{\funcname}{\noindent\texttt{shu-find-end-include }}
\usebox{\funcname}\emph{dir}
\index{shu-find-end-include} \hfill [Function]
...
include directive.  If \emph{dir} is positive the search is forward, else backward.
...
\vspace{1em}
\noindent
\savebox{\funcname}{\noindent\texttt{shu-line-is-include }}
\usebox{\funcname}\textbf{\&optional} \emph{fix}
\index{shu-line-is-include} \hfill [Function]
...
\usebox{\funcname}\emph{proj-list}
\index{shu-internal-list-c-file-names} \hfill [Command]
...
\vspace{1em}
\noindent
\savebox{\funcname}{\noindent\texttt{shu-git-branch-to-kill-ring }}
\usebox{\funcname}
\index{shu-git-branch-to-kill-ring} \hfill [Command]
