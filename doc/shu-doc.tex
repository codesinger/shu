...
\usebox{\funcname}\emph{class-list} \emph{using} \emph{top-qual} \emph{gb}
...
\emph{using} is the regular expression used to search for ``using namespace''
directives.  \emph{top-qual} is the regular expression used to strip out a higher level
...
\vspace{1em}
\noindent
\savebox{\funcname}{\noindent\texttt{shu-gincl }}
\usebox{\funcname}
\index{shu-gincl} \hfill [Command]\\%
 (Alias: gincl)
