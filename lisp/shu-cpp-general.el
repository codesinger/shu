...
(defconst shu-bsl-include-list
  (list
   ...
   (cons "bsl_random.h"   (list
                           "bsl::bernoulli_distribution"
                           "bsl::binomial_distribution"
                           "bsl::cauchy_distribution"
                           "bsl::chi_squared_distribution"
                           "bsl::default_random_engine"
                           "bsl::discard_block_engine"
                           "bsl::discrete_distribution"
                           "bsl::exponential_distribution"
                           "bsl::extreme_value_distribution"
                           "bsl::fisher_f_distribution"
                           "bsl::gamma_distribution"
                           "bsl::geometric_distribution"
                           "bsl::independent_bits_engine"
                           "bsl::knuth_b"
                           "bsl::linear_congruential_engine"
                           "bsl::lognormal_distribution"
                           "bsl::mersenne_twister_engine"
                           "bsl::minstd_rand"
                           "bsl::minstd_rand0"
                           "bsl::mt19937"
                           "bsl::mt19937_64"
                           "bsl::negative_binomial_distribution"
                           "bsl::normal_distribution"
                           "bsl::piecewise_constant_distribution"
                           "bsl::piecewise_linear_distribution"
                           "bsl::poisson_distribution"
                           "bsl::random_device"
                           "bsl::ranlux24"
                           "bsl::ranlux24_base"
                           "bsl::ranlux48"
                           "bsl::ranlux48_base"
                           "bsl::seed_seq"
                           "bsl::shuffle_order_engine"
                           "bsl::student_t_distribution"
                           "bsl::subtract_with_carry_engine"
                           "bsl::uniform_int_distribution"
                           "bsl::uniform_real_distribution"
                           "bsl::weibull_distribution"
                           ))
